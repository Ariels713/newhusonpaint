      ...
      <div className="container px-5 mx-auto lg:px-24 ">
        <div className="flex flex-col w-full mb-12 text-center">
          <h2 className="mb-4 text-xs font-semibold tracking-widest text-black uppercase title-font">
            ...
            <a
              href="#"
              className="font-semibold text-yellow-400 lg:mb-0 hover:text-black"
            >
              Our Clients »
            </a>
          </h2>
        ...
        <div className="grid grid-cols-3 gap-16 text-center lg:grid-cols-6">
          <div className="flex items-center justify-center ">
            <img
              ...
              alt="Todoist Logo"
              className="block object-contain h-10 filter grayscale"
            />
          </div>
          <div className="flex items-center justify-center ">
            <img
          ...
          <div className="flex items-center justify-center ">
            <img
              src="https://d33wubrfki0l68.cloudfront.net/bd27dc44fc4b5c47e46941477c7d332a60d57351/09469/logos/volkswagen.svg"
              alt="Postcss Logo"
              className="block object-contain h-10 filter grayscale"
            />
          </div>
          <div className="flex items-center justify-center ">
            <img
              src="https://d33wubrfki0l68.cloudfront.net/7f4ce7b480fdac0e72b719c7de1c37f4e3792529/1f376/logos/stripe.svg"
              alt="Yahoo Logo"
              className="block object-contain h-10 filter grayscale"
            />
          </div>
